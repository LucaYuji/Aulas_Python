...
def main():
    ...
    visor(media_total, mediana_total, moda_total, desvio_padrao_total, turma, materia, nome_lista, lista_media_por_aluno)
    grafics(lista_media_por_aluno, nome_lista)
main()
